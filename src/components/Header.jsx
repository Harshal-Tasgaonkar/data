...
const Header = () => {
  ...
  <a className="close-icon ms-auto" onClick={closeDropdown}> {/* Close icon to close dropdown */}
          ...
          <Link to="/userdashboard" className="dropdown-item">Home</Link>
          <Link to="/usersubscriptionlistview" className="dropdown-item">Subscription</Link>
          <Link to="/userhistory" className="dropdown-item">File Download</Link>
