...
const Navbar = () => {
  ...
  const [dropdownOpen, setDropdownOpen] = useState(false); // {{ edit_1 }}

  const toggleDropdown = (e) => { // {{ edit_2 }}
    e.preventDefault(); // Prevent default action
    setDropdownOpen(prevState => {
      
      const newState = !prevState; // Toggle state
      
      return newState; // Return new state
    });
  };

  const closeDropdown = () => { // {{ edit_3 }} 
  ...
  <div className="container-xxl">
    ...
    <div className="layout-menu-toggle navbar-nav align-items-xl-center me-4 me-xl-0 d-xl-none">
        <a className="nav-item nav-link px-0 me-xl-6" onClick={toggleDropdown}> {/* {{ edit_3 }} */}
      ...
      {dropdownOpen && ( // {{ edit_4 }}
        ...
        <div className="dropdown-menu show " style={{ display: 'block',width: '60%', marginTop: '150px', left: '0', position: 'absolute' }}>
           {/* Ensure 'show' class is added for visibility */}

           <div className="navbar-brand app-brand demo d-xl-flex py-0 me-6 ms-4 mt-4">
  ...
  <a className="close-icon ms-auto" onClick={closeDropdown}> {/* Close icon to close dropdown */}
              <i className="bx bx-x" />
            </a>
</div>


          <Link to="/admindashboard" className="dropdown-item">Home</Link>
          <Link to="/subscriptionlistview" className="dropdown-item">Manage Subscription</Link>
          <Link to="/adminuserlistview" className="dropdown-item">Manage User</Link>
          <Link to="#" className="dropdown-item">Manage Data</Link>
          <Link to="/signup" className="dropdown-item">File Upload</Link>
        </div>
      )}
  ...
  <ul className="dropdown-menu dropdown-menu-end dropdown-styles">
            ...
            <li>
              <div className="d-grid px-4 pt-2 pb-1">
                ...
                >
                  ...
                  <i className="bx bx-log-out ms-2 " />
                </a>
              </div>
            </li>
          </ul>
    ...
    <div className="navbar-search-wrapper search-input-wrapper container-xxl d-none">
      ...
      <i className="bx bx-x search-toggler cursor-pointer" />
    </div>
  </div>
</nav>
